...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices and league games for basketball players",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "ryan@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and water safety sessions for students",
    ...
    "Drama Club": {
        "description": "Rehearse scenes and prepare performances for the school year",
